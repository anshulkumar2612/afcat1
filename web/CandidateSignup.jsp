<%-- 
    ...
    Created on : 18 Jul, 2018, 12:10:06 AM
    Author     : Anshu
--%>
...
<html>
    ...
    <body>
        ...
        <div id="mydiv" class="login-form" style="opacity: 0.7;">
            <form action="userSignup" method="post" onsubmit="return check()">
                <h2 class="text-center" style="color: cadetblue;">Sign Up Form</h2>       
                <div class="form-group">
                    <input type="text" name="username" class="form-control" placeholder="Enter Username" required="required" >
                </div>
                <div class="form-group">
                    <input type="password" id="pwd" name="password" class="form-control" placeholder="Enter Password" required="required" >
                </div>
                <div class="form-group">
                    <input type="password" id="rpwd" name="retypepassword" class="form-control" placeholder="Re-Type Password" required="required" >
                </div>
                <div class="form-group">
            ...
            <%
                ...
                else if("SignUp Successful".equalsIgnoreCase(message))
                {
                    
            %>
                <div style="background-color: green;color: white;"><p class="text-center"><%=session.getAttribute("Message2")%></p></div>
            <% session.setAttribute("Message2",null);
                response.setHeader("Refresh", "2;url=index.jsp");}
                else
                {%>

            <div style="background-color: red;color: white;"><p class="text-center"><%=session.getAttribute("Message2")%></p></div>
            <%session.setAttribute("Message2",null);}
                %>
