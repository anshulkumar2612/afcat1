	...
	function playVid()
	{
        ...
        <div id="mydiv" class="login-form" style="opacity: 0.7;">
            <form action="userLogin" method="post">
                <h2 class="text-center" style="color: cadetblue;">Log in</h2>       
                ...
                <div class="clearfix">
                    <p class="pull-left checkbox-inline"><a href="CandidateSignup.jsp">Create an Account</a></p>
                    <a href="CandidateForgetPassword.jsp" class="pull-right">Forgot Password?</a>
                </div>        
            </form>
            <%
                ...
                else if("Login Successful".equalsIgnoreCase(message))
                {
                    
            %>
                <div style="background-color: green;color: white;"><p class="text-center"><%=session.getAttribute("Message1")%></p></div>
            ...
            <div style="background-color: red;color: white;"><p class="text-center"><%=session.getAttribute("Message1")%></p></div>
            <%session.setAttribute("Message1",null);}
                %>
